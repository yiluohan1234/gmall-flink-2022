...
public class BaseDBApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MapStateDescriptor<String, TableProcess> mapStateDescriptor =
                new MapStateDescriptor<>("map-state", String.class, TableProcess.class); // 根据表的信息，写key， value
        ...
        kafkaJsonDS.addSink(MyKafkaUtil.getKafkaProducer(new KafkaSerializationSchema<JSONObject>() {
            @Override
